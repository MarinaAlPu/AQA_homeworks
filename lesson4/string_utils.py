...
class StringUtils:
    ...
    def capitilize(self, string: str) -> str: # аннотация - содержит ожидаемый тип
...
# # x = string_utils.to_list("буква, цифра, спецсимвол, знак препинания, смайлик,", "")
# # x = string_utils.contains("string", "q")
# print(x)
