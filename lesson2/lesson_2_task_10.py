...
# сократить строки кода (например, по аналогии с задание 2).
# И несмотря на то, что в условиях это не прописано,
# итоговую сумму лучше округлять до двух знаков после запятой.
